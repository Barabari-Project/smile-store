  ...
  const handleSubmit = async (e) => {
    ...
    const submitPromise = new Promise(async (resolve, reject) => {
      try {
        ...
        if (files.incomeCertificate) formDataToSend.append('incomeCertificate', files.incomeCertificate);
      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50 py-12">
        <form onSubmit={handleSubmit} className="max-w-2xl mx-auto p-6 space-y-6 bg-white rounded-xl shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Why are you seeking Compassionate Credit? <span className="text-red-500">*</span>
              </label>
              <textarea
                name="reason"
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">
                Upload salary slip, income certificate, or bank statement
              </p>
            </div>

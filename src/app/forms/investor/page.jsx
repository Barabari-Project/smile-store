...
export default function InvestorForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      !formData.smileCatalyst &&
      !formData.smileEnabler &&
      !formData.smileDelivery &&
      !formData.compassionateCredit
    ) {
      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50 py-12">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Why do you want to invest in SMILE Store?{" "}
                <span className="text-red-500">*</span>
              </label>
              <textarea
                name="motivation"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Business Registration (PDF format)
              </label>
              <input
                type="file"
              ...
              <p className="text-xs text-gray-500 mt-1">
                Upload business registration documents in PDF format
              </p>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Financial Proof (PDF format)
              </label>
              <input
                type="file"
                name="financialProof"

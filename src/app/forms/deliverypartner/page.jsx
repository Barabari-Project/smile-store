    ...
    const submitPromise = new Promise(async (resolve, reject) => {
      try {
        ...
        if (files.vehicleInsurance)
          formDataToSend.append("vehicleInsurance", files.vehicleInsurance);
      ...
      <main className="min-h-screen bg-gradient-to-b from-white to-blue-50 py-12">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                Why do you want to join SMILE Delivery?{" "}
                <span className="text-red-500">*</span>
              </label>
              <textarea
                name="motivation"
            ...
            <div>
              ...
              />
              <p className="text-xs text-gray-500 mt-1">
                Upload your vehicle insurance document in PDF format.
              </p>
            </div>

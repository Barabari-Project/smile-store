...
const WhatsInStore = () => {
  const cards = [
    ...
    },
    {
      ...
      text: "Thoughtful pricing for elders, low-income households, and marginalized groups.",
    },
    {
      color: "bg-red-900",
  ...
  return (
    <section className="bg-gray-100 py-12 m-10">
      <div className="container mx-auto px-6">
        <h2 className="text-6xl md:text-6xl font-bold font-serif text-center text-gray-700 mb-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 py-10">
            {cards.map((card, index) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3
                    className={`text-3xl font-semibold font-serif mb-2 ${card.headingColor}`}
                  >
                    {card.heading}
                  </h3>

                  <p
                    className={`text-lg font-poppins font-semibold ${card.subTextHeadingColor}`}
                  >
                    {card.text}
                  </p>
                </div>
